...
<!-- Form -->
    <g:form class="form" controller="employee" action="create" method="POST">
        ...
        <div class="row-content">
            ...
            <label for="salary"></label><input class="input" type="range" name="salary" id="salary" min="300000" max="5000000" step="1000" value="4000000" required>
        ...
        <div class="row-content">
            ...
            <div id="date">
                <g:select id="day" name="date.day" from="${1..31}" value="${day}"
                          noSelection="['':'Day']"/>
                <g:select id="month" name="month.category" from="${['Jan', 'Feb', 'Mar',"Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]}"
        ...
        <div class="buttonParent">
            <g:link controller="employee" action="index" class="resetButton button cancelButton" ><g:message code="user.cancel"/></g:link>
            <div class="submit-reset">
                <g:submitButton class="button submitButton" name="save" value="${g.message(code: "user.submit")}"/>
